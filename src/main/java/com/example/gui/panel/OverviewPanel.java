...
public class OverviewPanel extends RightPanel {
    ...
    public OverviewPanel(MainFrame frame) {
        super(frame, new TransactionTableData(new FunctionsHandler(frame, new TransferAddEditDialog(frame)), Settings.COUNT_OVERVIEW_ROWS),
                Text.PANEL_LAST_TRANSACTIONS, Style.ICON_PANEL_OVERVIEW);
    }
}